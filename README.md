...
## 15 TODOs
1. session.d.ts — declare module
2-3. app.ts — import + configurar session
4. userModel.ts — interface User + bcrypt (registrar + login)
5-10. authRoutes.ts — login, registro, POST registro/login, logout
